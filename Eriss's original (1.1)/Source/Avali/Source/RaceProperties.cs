...
namespace Verse
{
	public class RaceProperties
	{
		...
		public IEnumerable<string> ConfigErrors()
		{
			...
			RaceProperties.<ConfigErrors>c__Iterator0 expr_0E = <ConfigErrors>c__Iterator;
			expr_0E.$PC = -2;
			return expr_0E;
		}
		...
		internal IEnumerable<StatDrawEntry> SpecialDisplayStats(ThingDef parentDef)
		{
			...
			RaceProperties.<SpecialDisplayStats>c__Iterator1 expr_15 = <SpecialDisplayStats>c__Iterator;
			expr_15.$PC = -2;
			return expr_15;
		}
	}
