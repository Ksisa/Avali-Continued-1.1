...
namespace Avali
{
	...
	{
		public Material BubbleMat; // edited
		...
		*/
		...
		private void AbsorbedDamage(DamageInfo dinfo)
		{
			...
			MoteMaker.MakeStaticMote(loc, base.Wearer.Map, RimWorld.ThingDefOf.Mote_ExplosionFlash, num);
			int num2 = (int)num;
		...
		private void Break()
		{
			...
			MoteMaker.MakeStaticMote(base.Wearer.TrueCenter(), base.Wearer.Map, RimWorld.ThingDefOf.Mote_ExplosionFlash, 12f);
			for (int i = 0; i < 6; i++)
			{
		...
		public override void DrawWornExtras()
		{
			if (this.ShieldState == ShieldState.Active && this.ShouldDisplay)
			{
				...
				if (BubbleMat == null) SetBubbleMatMat(); // added
				Graphics.DrawMesh(MeshPool.plane10, matrix, BubbleMat, 0); // edited
			}
		}
		...
		public virtual void SetBubbleMatMat() // added
		{
			BubbleMat = MaterialPool.MatFrom("Things/Avali/Apparel/ShieldBelt/ShieldBubble", ShaderDatabase.Transparent);
		}
	}
}
